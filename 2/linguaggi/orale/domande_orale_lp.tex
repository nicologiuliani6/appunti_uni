...
\domanda{1}{Definizione di ambiente.}{}
\domanda{2}{Cos'è un blocco?}{}
\domanda{3}{Differenza tra scope statico e dinamico. Qual è il loro potere espressivo?}{}
\domanda{4}{Scope statico implementato con catena statica: come funziona? E scope dinamico con catena dinamica? Vantaggi e svantaggi?}{}
\domanda{5}{Come si determina il contatore di catena statica?}{}

\domanda{6}{Differenza tra espressione e comando.}{}
\domanda{7}{Nei linguaggi funzionali ci sono comandi?}{}
\domanda{8}{Differenza tra iterazione determinata e indeterminata.}{}
\domanda{9}{Quali sono i comandi condizionali? Vantaggi tra if e switch.}{}

\domanda{10}{Cos'è il passaggio per riferimento e come funziona?}{}
\domanda{11}{Quando una funzione restituisce un'altra funzione come parametro, cosa succede?}{}
\domanda{12}{Cos'è la ricorsione in coda?}{}

\domanda{13}{Come sono memorizzati gli array? Cos'è il dope vector?}{}
\domanda{14}{Come funziona l'invocazione dinamica di un metodo? Come avviene l'invocazione Object-oriented?}{}
\domanda{15}{Cos'è un sottotipo? Ereditarietà e sottotipi in Java.}{}
\domanda{16}{Metodi per implementare l'ereditarietà.}{}
\domanda{17}{Differenza tra parte pubblica e parte privata.}{}

\domanda{18}{Cos'è il tipo void? Che insieme di valori denota?}{}
\domanda{19}{Esistono linguaggi non tipati? Che vantaggi ci sono? Dal punto di vista dell'efficienza cambia qualcosa?}{}

\domanda{20}{Cos'è il CRT e a cosa serve?}{}
\domanda{21}{Garbage collection: come funzionano i contatori dei riferimenti?}{}
\domanda{22}{Posso implementare la comunicazione sincrona con quella asincrona?}{}

% ================================================================
\section{Modulo 3 -- Giallorenzo}
% ================================================================

\domanda{1}{A cosa servono i sistemi di tipi?}{}
...
\domanda{4}{Come funziona il sistema di tipi di JavaScript e Python?}{}
\domanda{5}{Controlli statici sui tipi contro controlli dinamici. Cenno all'halting problem.}{}

\domanda{6}{Differenza tra tipaggio nominale e strutturale. Perché sceglierne uno o l'altro? Pro e contro.}{}
\domanda{7}{Cos'è il duck typing e connessione con lo structural typing. Pro e contro.}{}
\domanda{8}{Differenza tra manifest e inferred typing. Pro e contro.}{}
\domanda{9}{Descrivimi l'algoritmo di unificazione e il suo funzionamento.}{}
\domanda{10}{Che tipaggio usa Java?}{}
\domanda{11}{Come funzionano equivalenza e comparazione nel typing nominale?}{}

\domanda{12}{Cos'è un tipo prodotto? Fai un esempio.}{}
\domanda{13}{Cos'è un tipo somma? Qual è la differenza tra tipo somma e tipo prodotto?}{}
\domanda{14}{Differenza tra definizione estensionale e intensionale. Come si combina col sub-typing?}{}
\domanda{15}{Sottotipaggio e definizione degli enum. Differenza tra int ed enum.}{}
\domanda{16}{Definisci un tipo ricorsivo prodotto. Quale potrebbe essere un suo abitante?}{}
\domanda{17}{Cos'è un tipo ricorsivo?}{}
\domanda{18}{Come scriverebbe il tipo lista come tipo ricorsivo prodotto?}{}
\domanda{19}{Cos'è un tipo intersezione?}{}
\domanda{20}{Cosa sono i tipi parametrici? In che modo sono utilizzati nel polimorfismo?}{}

\domanda{21}{Quali sono i tipi di polimorfismo?}{}
\domanda{22}{Polimorfismo di sovraccarico e dynamic dispatch: quali sono le differenze?}{}
\domanda{23}{Controvarianza e covarianza: quando le troviamo e come mai?}{}
\domanda{24}{Cos'è il sub-typing?}{}
\domanda{25}{Nel momento in cui dico che A è un sottotipo di B, quali proprietà deve avere A?}{}
\domanda{26}{Principio di sostituzione di Liskov.}{}

\domanda{27}{Quali sono i 4 pilastri dell'OOP? (attenzione: dynamic dispatch al posto di polimorfismo)}{}
\domanda{28}{Classi, oggetti, interfacce e prototipi: differenze e caratteristiche.}{}
\domanda{29}{Differenza tra sistemi basati su classi e sistemi basati su prototipi. Che garanzie offrono?}{}
\domanda{30}{La relazione tra sottotipaggio ed ereditarietà nell'OO. Differenza pratica tra sottotipi e sottoclassi.}{}
\domanda{31}{Ereditarietà singola e multipla: differenze e metodi per risolvere i conflitti.}{}
\domanda{32}{Perché i costruttori si possono solo sovraccaricare e non fare overriding?}{}
\domanda{33}{Differenza tra overriding e overloading.}{}

\domanda{34}{I 2 metodi di implementazione del dynamic dispatch. Qual è il più efficiente?}{}
\domanda{35}{Come si fa in memoria il dynamic dispatch? Come si memorizzano vtable e funzioni?}{}
\domanda{36}{In una classe, dove vivono i metodi e i campi e come vengono memorizzati?}{}
\domanda{37}{Cos'è il problema della classe base fragile?}{}

\domanda{38}{Coercizione e casting: cosa sono e differenze.}{}
\domanda{39}{Differenza tra typed casting e type coercion. Perché non si usano nel polimorfismo generale in Java?}{}
\domanda{40}{Differenza tra void e unit.}{}
\domanda{41}{Differenza tra maybe e option.}{}

\domanda{42}{Differenza tra array unidimensionali e multidimensionali. Row-major vs column-major: pro, contro e caching.}{}
\domanda{43}{Array in relazione a weakly-typed e C. Vantaggi e svantaggi dell'interoperabilità tra array e puntatori.}{}
\domanda{44}{Cos'è il dope vector e qual è il suo utilizzo? Dove viene allocato?}{}
\domanda{45}{Differenza degli array fra Java e C. Come fa Java a gestire gli array?}{}

\domanda{46}{Garbage collection: quali implementazioni abbiamo visto e come funzionano?}{}
\domanda{47}{Limiti del reference counting.}{}
\domanda{48}{Garbage collector con il costo più basso di memoria?}{}
\domanda{49}{Problemi di un garbage collector stop-the-world. In quali applicazioni crea problemi? Alternative?}{}
\domanda{50}{Cosa significa che un valore non è garbage?}{}
\domanda{51}{Cosa sono i dangling pointers e le dangling reference?}{}
\domanda{52}{Cos'è una use after free?}{}
\domanda{53}{Cosa sono i wide pointers / initialized pointers?}{}
\domanda{54}{Tecniche di protezione della memoria e loro problemi.}{}

\domanda{55}{Cosa sono le eccezioni? A cosa servono? Come sono gestite in Java?}{}
\domanda{56}{Ci sono similitudini tra eccezioni e tipaggio?}{}
\domanda{57}{Tipi di gestione degli errori. Cos'è il result type? Cos'è il tipo option/maybe?}{}

\domanda{58}{Differenza tra abstract data types e oggetti. Possono convivere nello stesso codice?}{}
\domanda{59}{Definisci i tipi di dato astratti.}{}
\domanda{60}{Cosa vuol dire dal punto di vista concettuale e pratico avere diverse visibilità (pubblica/privata)?}{}

\domanda{61}{Se le funzioni fossero come le funzioni matematiche, come potremmo ottimizzarne l'esecuzione?}{}
\domanda{62}{Cos'è una relazione? Come ottimizzare il calcolo di una funzione con dominio molto piccolo?}{}
\end{document}