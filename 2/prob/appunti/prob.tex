...
Faremo cio' indipendentemente dal valore assunto da $r_{xy}$, tuttavia tale relazione lineare sara' chiaramente tanto pi`u significativa quanto pi`u $|r_{xy}|$ assumera' un valore vicino ad 1.\\
\vspace{1px}\\
...
\begin{align*}
  y = mx + q
\end{align*}
passi il pi`u vicino possibile a tutti i punti $(x_i, y_i)$. Per ogni punto consideriamo l'\textit{errore relativo} a tale punto (anche detto \textit{errore pariziale}), ovvero la differenza tra il valore reale e quello lungo la retta
\begin{align*}
  e_i \, := \, y_i - m x_i - q
\end{align*}
...
\begin{itemize}
  ...
  \item l’ordine di convergenza del metodo, che e' $\frac{1}{\sqrt{n}}$ come seguir`a dal Teorema centra-
le del limite, e' indipendente dalla dimensione e l’implementazione del metodo in
dimensione maggiore di uno non comporta alcuna difficolt`a aggiuntiva.
\end{itemize}
